...
Below is shown the result on the last 470 days of data (not used for training).
In blue, we follow the prediction of the CNN, in red we go opposite following the criteria depicted above.
