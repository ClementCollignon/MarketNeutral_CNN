...
The dropout might be still even too high as the train data underperform the validation one. ( Nop just realize a mistake in the code that reshuffles at every epoch ...)
